...
//	    console.log("wapo right");
    ...
    function swap_left(can1, div1, can2, div2, str, bl, br, dt1, dt2) {
	hide_all();
	...
	if (!bl && !br) {
	    ...
	    loadPdf(cdate + str, can1, div1, can2, div2, dt1, dt2);
	} else if (br) {
    ...
    function swap_right(can1, div1, can2, div2, str, bl, br, dt1, dt2) {
	hide_allright();
	var gc =  document.getElementById(can1);
	var gd = document.getElementById(div1);
	gc.style.visibility = 'visible';
	...
	swap_left('cnn-canvas', 'div-cnn', 'cnn-canvas-right', 'div-cnn-right', cnn, cnnl, cnnr, 'div-cnn-text', 'div-cnn-text-right');
	cnnl = true;
    }

    function swapCanvases1right(){
	swap_right('cnn-canvas-right', 'div-cnn-right', 'cnn-canvas', 'div-cnn', cnn, cnnl, cnnr, 'div-cnn-text-right', 'div-cnn-text');
	cnnr = true;
    }

    function swapCanvases2(){
	swap_left('nytimes-canvas', 'div-nyt', 'nytimes-canvas-right', 'div-nyt-right', nyt, nytl, nytr, 'div-nyt-text', 'div-nyt-text-right');
	nytr = true;
    }

    function swapCanvases2right(){
	swap_right('nytimes-canvas-right', 'div-nyt-right', 'nytimes-canvas', 'div-nyt', nyt, nytl, nytr, 'div-nyt-text-right', 'div-nyt-text');
	nytr = true;
    }

    function swapCanvases3(){
	swap_left('fox-canvas', 'div-fox', 'fox-canvas-right', 'div-fox-right', fox, foxl, foxr, 'div-fox-text', 'div-fox-text-right');
	foxl = true;
    }

    function swapCanvases3right(){
	swap_right('fox-canvas-right', 'div-fox-right', 'fox-canvas', 'div-fox', fox, foxl, foxr, 'div-fox-text-right', 'div-fox-text');
	foxr = true;
    }

    function swapCanvases4(){
	swap_left('wsj-canvas', 'div-wsj', 'wsj-canvas-right', 'div-wsj-right', wsj, wsjl, wsjr, 'div-wsj-text', 'div-wsj-text-right');
	wsjl = true;
    }

    function swapCanvases4right(){
	swap_right('wsj-canvas-right', 'div-wsj-right', 'wsj-canvas', 'div-wsj', wsj, wsjl, wsjr, 'div-wsj-text-right', 'div-wsj-text');
	wsjr = true;
    }
    function swapCanvases5(){
	swap_left('wapo-canvas', 'div-wapo', 'wapo-canvas-right', 'div-wapo-right', wapo, wapol, wapor, 'div-wapo-text', 'div-wapo-text-right');
	wapol = true;
    }

    function swapCanvases5right(){
	swap_right('wapo-canvas-right', 'div-wapo-right', 'wapo-canvas', 'div-wapo', wapo, wapol, wapor, 'div-wapo-text-right', 'div-wapo-text');
	wapor = true;
    }
